...
export const DICT = {
  ko: {
    ...
    'dv.g.verified': '실측',
    'dv.g.law': '법 조문',
    'vd.title': '이 건물, 지금 용도에 적합한가',
    'vd.sub': '여섯 신호를 적합·미흡으로 가르고, 세어서 적합성을 판정합니다.',
    'vd.inTitle': '판정의 입력',
    ...
    'vd.callHead': '현 용도에 적합하다 — 다만 {y}년에는 다시 정해야 한다',
    'vd.eqOut': '용도를 다시 보는 해',
    'vd.tally': '신호를 세면',
    'vd.tallyNote': '적합한 것만 세지 않습니다. 같은 승하차 자료도 12개월로 보면 오르고 2019년과 견주면 못 돌아왔습니다 — 둘 다 적었습니다.',
    'vd.d.good': '적합',
    'vd.d.bad': '미흡',
    'vd.d.wait': '쌓는 중',
    'vd.sigTitle': '무엇이 적합하고 무엇이 미흡한가',
    'vd.sigSub': '축마다 어느 기간으로 본 것인지 함께 밝힙니다',
    'vd.readTitle': '그래서 무엇이라 말하는가',
    'vd.readSub': '신호 하나로는 못 하고, 둘이 합쳐야 나오는 말입니다',
    'vd.driftTitle': '그런데 왜 계속 적합하지는 않은가',
    'vd.driftSub': '지금 적합한 것과 앞으로도 적합한 것은 다른 말입니다',
    ...
    'cf.title': '이 비용 구조로 계산됩니다',
    'cf.sub': '백병훈·조중연(2014) 비용분류체계 · 50년 현재가치',
    'cf.ready': '{n}% 확보',
    'cf.confirmed': '확보 {n}',
    'cf.estimate': '참조값 {n}',
    'cf.missing': '미확보 {n}',
    'cf.note':
      '금액 총액은 아직 내지 않습니다 — 용도별 ㎡당 공사비와 재건축·대수선 단가 '
      + '2종이 확보되면 채워집니다. 지금 확정된 것은 시점(법정 주기)과 이 구조입니다.',
    'tm.title': '언제 손봐야 하는가',
    ...
    'tj.gradeNote':
      ...
      + '화면의 수치는 스크립트 출력과 일치합니다. 갱신 주기는 축마다 달라 '
      + '카드 밑에 자료원을 함께 적었습니다.',
    'tj.axCalc': '계산',
    'tj.axCalcD': '같은 자를 대고 돌아간다',
    'tj.axData': '자료',
    'tj.axDataD': '다섯 축 모두 자료원에 붙어 있다',
    'tj.axDone': '검증 완료',
    'tj.axLinked': '실측 연결',
    'tj.g.verified': '실측 검증 완료',
    'tj.g.collecting': '계산 검증 완료',
    'mf.title': '이 근거는 왜 필요한가',
    'df.aria': '노원구 고령 비율은 매끄럽게 오르고, 이 건물은 손댄 해에만 움직인다',
    'df.town': '동네 — 65세 이상 비율',
    'df.bldg': '건물 — 손댄 해',
    ...
    'sm.site': '대상지',
    'sm.ctrl': '{n}개 정류장 평균',
    'sm.away': '대조군 셋은 1.7~2.3 km 북쪽 · 화면 밖',
  ...
  it: {
    ...
    'dv.g.law': 'norma',
    'vd.title': 'Questo edificio è idoneo alla destinazione attuale?',
    'vd.sub': 'Sei segnali letti come idonei o carenti, contati per ricavarne l\'idoneità.',
    ...
    'vd.callHead': 'Idoneo alla destinazione attuale — ma nel {y} va ridefinita',
    'vd.eqOut': 'Anno del riesame',
    'vd.tally': 'Contando i segnali',
    'vd.tallyNote': 'Non contiamo solo ciò che è idoneo: lo stesso dato sale su dodici mesi e non è tornato rispetto al 2019. Sono scritti entrambi.',
    'vd.d.good': 'Idoneo',
    'vd.d.bad': 'Carente',
    'vd.d.wait': 'In raccolta',
    'vd.sigTitle': 'Che cosa è idoneo e che cosa è carente',
    'vd.sigSub': 'Per ogni asse indichiamo anche su quale periodo è letto',
    'vd.readTitle': 'Che cosa dicono, allora',
    'vd.readSub': 'Sono affermazioni che un solo segnale non regge: ne servono due',
    'vd.driftTitle': 'Perché però non resterà idoneo',
    'vd.driftSub': 'Essere idoneo oggi e restarlo domani non sono la stessa cosa',
    ...
    'plan.mapCol5': 'Che cosa facciamo noi',
    ...
    'cf.title': 'La struttura di costo del calcolo',
    'cf.sub': 'Classificazione dei costi (Baek·Cho 2014) · valore attuale a 50 anni',
    'cf.ready': '{n}% disponibile',
    'cf.confirmed': 'Disponibili {n}',
    'cf.estimate': 'Riferimento {n}',
    'cf.missing': 'Mancanti {n}',
    'cf.note':
      'Non diamo ancora un totale: servono due costi unitari (costo al m² per uso e '
      + 'costo di ricostruzione/grande intervento). Per ora sono certe le date '
      + '(cicli di legge) e questa struttura.',
    ...
    'tj.gradeNote':
      'Calcolo e dato sono dichiarati separatamente. Tutti e cinque gli assi usano lo stesso '
      + 'metro e i numeri a schermo coincidono con l\'output degli script. La frequenza di '
      + 'aggiornamento varia per asse: la fonte è indicata sotto ogni scheda.',
    'tj.axCalc': 'Calcolo',
    'tj.axCalcD': 'gira con lo stesso metro',
    'tj.axData': 'Dato',
    'tj.axDataD': 'Tutti e cinque gli assi sono agganciati alla fonte',
    ...
    'df.aria': 'La quota di anziani sale con continuità; l\'edificio si muove solo negli anni in cui lo si tocca',
    'df.town': 'Quartiere — quota di over 65',
    'df.bldg': 'Edificio — anni di intervento',
    ...
    'sm.away': 'Le tre di controllo sono 1,7–2,3 km a nord, fuori inquadratura',
  ...
  en: {
    ...
    'vd.eqOut': 'Year of the re-assessment',
