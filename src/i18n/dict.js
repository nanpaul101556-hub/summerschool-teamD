...
export const DICT = {
  ko: {
    ...
    'dv.g.verified': '실측',
    'dv.g.law': '법 조문',
    'vd.title': '지금 이 건물, 좋은가 나쁜가',
    'vd.sub': '모은 자료를 하나씩 좋다·나쁘다로 가르고, 세어서 결론을 냅니다.',
    'vd.inTitle': '판정의 입력',
    ...
    'ms.paid': '행정도 따라왔다',
    'ms.back': '그래도 못 돌아왔다',
    'ms.backD': '노원구 평균 {n} 아래 · 2019.07 = 100',
    'ms.link': '실측이 붙은 축',
    'ms.lead': '아래 다섯 카드에서 하나씩 근거를 편다.',
    'ms.live': '실시간 호출',
    'ms.liveList': '대상지를 넣는 순간 — V-World 주소검색 · 필지 경계 · 용도지역 · 위성 영상',
    'sm.title': '어디서 재는가',
    'sm.site': '대상지',
    'sm.ctrl': '{n}개 정류장 평균',
  ...
  it: {
    ...
    'dv.g.law': 'norma',
    'vd.title': 'Questo edificio, oggi: bene o male?',
    'vd.sub': 'Ogni segnale è letto come positivo o negativo, poi si contano e se ne ricava il giudizio.',
    ...
    'vd.sigTitle': 'Che cosa va bene e che cosa no',
    ...
    'vd.driftTitle': 'Perché però non «per sempre»',
    'vd.driftSub': 'Funzionare oggi e funzionare domani non sono la stessa cosa',
    ...
    'ms.title': 'Quello che è emerso finora',
    'ms.came': 'La gente è venuta di più',
    'ms.paid': 'Il bilancio ha seguito',
    'ms.back': 'Ma non è tornato ai livelli pre-Covid',
    'ms.backD': 'Sotto la media di Nowon, {n} · 07.2019 = 100',
    'ms.link': 'Assi con dato misurato',
    'ms.lead': 'Le cinque schede sotto aprono una prova ciascuna.',
    'ms.live': 'Chiamata in tempo reale',
    'ms.liveList': 'All\'inserimento del sito — V-World: indirizzo, particella, zonizzazione, ortofoto',
