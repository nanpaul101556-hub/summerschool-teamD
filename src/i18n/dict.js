...
export const DICT = {
  ko: {
    ...
    'tm.headV': '{built}년에 지어져 {turn}년에 용도를 바꿔야 하고, 점검은 {check}년에 온다',
    ...
    'tm.yrs': '년차',
    'tm.fromVerdict': '판정에서 나온 시점',
    'tm.fromLaw': '법에서 나온 시점',
    'tm.checkAt': '{art} · {n}년마다 오는 정기점검',
    'tm.hookL': '{y}년을 기억해 달라고 했습니다',
    'ev.title': '지금 이 건물, 제 용도로 잘 쓰이고 있는가',
    'ev.sub': '두 궤적이 벌어지는 지점을 봅니다. 그 지점이 용도를 다시 물어야 할 때입니다.',
    'tj.aria': '지역이 요구하는 용도와 지금 용도의 적합도, 두 선의 궤적',
    'tj.demand': '지역이 요구하는 용도',
    'tj.fit': '지금 용도의 적합도',
    'tj.gap': '모자란 폭',
    'tj.est': '여기부터 추계',
    'tj.estMark': '추계 구간',
    'tj.realMark': '실측 구간',
    'tj.closed': '{by} — 벌어지던 격차가 여기서 닫혔다',
    'tj.reopen': '다시 벌어지기 시작한다. 이번에는 닫는 개입이 없다',
    'tj.turn': '모자란 폭이 {n}pt를 넘는다 — 용도를 다시 물어야 할 때',
    'tj.head': '두 선이 벌어지는 지점',
    'tj.headV': '{y}년에 {n}pt를 넘는다 — 용도를 다시 물어야 할 때',
    'tj.elder': '65세 이상 비율',
    'tj.sub': '이 건물에는 「신축 사건」이 없다. 전후로 자르는 대신 두 궤적으로 본다.',
    'tj.how': '어떻게 그렸는가',
    'tj.inDemand': '수요선 · 노원구 인구 추계의 65세 이상 비율',
    'tj.inDemandF': '(고령비율 − 10) × 3.2 — 실측 2012–2024 · 추계 2026–2050',
    'tj.inFit': '적합도선 · 이 건물에 실제로 들어간 용도',
    'tj.inFitF': '예산 실집행 줄에서 확인된 용도 삽입 시점마다 계단으로 오른다',
    'tj.why': '수요는 인구라 매끄럽고 적합도는 손대야만 바뀌므로 계단이다. '
      + '그 모양 차이가 이 프로젝트의 논지다 — 동네는 계속 변하는데 건물은 누가 손댈 때만 변한다.',
    'tj.gradeTitle': '근거 등급',
  ...
  it: {
    ...
    'tm.headV': 'Costruito nel {built}, da riconvertire nel {turn}; il controllo cade nel {check}',
    ...
    'tm.legTurn': 'cambio di destinazione',
    'tm.pastTitle': 'Le date già avvenute, tutte verificate su fonte',
    'tm.yrs': '° anno',
    'tm.fromVerdict': 'data dal giudizio',
    'tm.fromLaw': 'data dalla legge',
    ...
    'ev.sub': 'Guardiamo dove le due traiettorie divergono: lì la destinazione va rimessa in discussione.',
    'tj.aria': 'Le due traiettorie: domanda del territorio e idoneità dell\'uso attuale',
    'tj.demand': 'uso richiesto dal territorio',
    'tj.fit': 'idoneità dell\'uso attuale',
    'tj.gap': 'scarto',
    'tj.est': 'da qui proiezione',
    'tj.estMark': 'proiezione',
    'tj.realMark': 'dato rilevato',
    'tj.closed': '{by} — qui lo scarto si è richiuso',
    'tj.reopen': 'Ricomincia ad aprirsi, e stavolta nessun intervento lo chiude',
    'tj.turn': 'Lo scarto supera {n} pt: va rimessa in discussione la destinazione',
    'tj.head': 'Dove le due linee divergono',
    'tj.headV': 'Nel {y} supera {n} pt: va rimessa in discussione la destinazione',
    'tj.elder': 'quota over 65',
    'tj.sub': 'Un edificio esistente non ha un "evento di costruzione": invece del prima/dopo, due traiettorie.',
    'tj.how': 'Come sono tracciate',
    'tj.inDemand': 'Domanda · quota di over 65 nelle proiezioni di Nowon',
    'tj.inDemandF': '(quota over 65 − 10) × 3,2 — rilevato 2012–2024, proiettato 2026–2050',
    'tj.inFit': 'Idoneità · gli usi realmente entrati in questo edificio',
    'tj.inFitF': 'Sale a gradini a ogni inserimento d\'uso confermato dalla spesa di bilancio',
    'tj.why': 'La domanda è demografia, quindi continua; l\'idoneità cambia solo quando si interviene, '
      + 'quindi a gradini. Quella differenza di forma è la tesi: il quartiere cambia sempre, '
      + 'l\'edificio solo quando qualcuno lo tocca.',
    ...
    'tj.feeds': 'Le prove che formano questa linea',
