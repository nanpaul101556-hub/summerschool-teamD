...
export const FACTS = [
  {
    ...
    label: K('앞 정류장 승하차', 'Flussi alla fermata', 'Boardings at the stop in front'),
    value: '+5.3%p',
    detail: K('전환 뒤 12개월 · 노원구 대조군 대비',
      'Dodici mesi dopo, sul controllo distrettuale',
      'Twelve months after, against the Nowon control'),
    to: 'used',
  },
  {
    id: 'budget', from: '03', grade: 'verified',
    label: K('예산 실집행', 'Spesa effettiva', 'Budget actually spent'),
    value: '+143%',
    detail: K('2022년 1.5억 → 2025년 3.6억 · 전부 용도 삽입',
      'Da 0,15 a 0,36 mld, tutto per inserire usi',
      'From 150 to 360 mn KRW, all of it inserting new uses'),
    to: 'used',
  },
  {
    id: 'gap', from: '01', grade: 'verified',
    label: K('손댄 간격', 'Intervallo fra gli interventi', 'Interval between interventions'),
    value: '3.5년',
    detail: K('2018 → 2022 → 2025 · 4년과 3년',
      '2018 → 2022 → 2025: quattro e tre anni',
      '2018 → 2022 → 2025: four years, then three'),
    to: 'rhythm',
  },
  {
    id: 'law', from: '05', grade: 'law',
    label: K('법정 점검 주기', 'Ciclo di controllo di legge', 'Statutory inspection cycle'),
    value: '3년',
    detail: K('건축물관리법 제13조③',
      'Legge sulla gestione degli edifici, art. 13 c.3',
...
export const READS = [
  {
    ...
    body: K(
      ...
      'More people come than in the control group, and the administration followed with money. '
      + 'What residents do and what the district decided point the same way.',
    ),
  },
  {
    id: 'rhythm',
    ...
    body: K(
      ...
      'The interval at which this building has been altered overlaps the inspection cycle the law '
      + 'sets. There is no need to fix a new date for intervening.',
    ),
  },
]
...
export const CALL_OUT = {
  ...
  body: K(
    ...
    'There is no reason to change now — it works. But this building has swapped its use every three '
    + 'or four years, and the inspection comes every three anyway. Attach the use review there and '
    + 'you do not open the site twice.',
  ),
}
...
export const UNUSED = {
  ...
  body: K(
    ...
    'The six signals do not carry equal weight. Entry records have a single building as their '
    + 'denominator and are the most precise; the satisfaction survey asks about the whole district '
    + 'and works more as background. If entries fall sharply at the next update, five fit axes '
    + 'become four and the re-assessment moves earlier.',
  ),
}
