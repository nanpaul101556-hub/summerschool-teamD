...
export const STOPS = [
  {
    ...
    label: K('대상지 앞', 'Davanti al sito', 'In front of the site'),
    sub: K('노원구민회관', 'Auditorium di Nowon', 'Nowon Civic Hall'),
    lat: 37.639366, lng: 127.066466, m: 46,
    raw: 77438, idx: 82.5,
  },
  {
    ars: '11374', kind: 'culture',
    label: K('북서울미술관 앞', 'Davanti al museo', 'In front of the museum'),
    sub: K('문화시설', 'Struttura culturale', 'Cultural facility'),
    lat: 37.640599, lng: 127.066333, m: 182,
    raw: 66430, idx: 72.0,
  },
  {
    ars: '11376', kind: 'transit',
    label: K('중계역 2번출구', 'Stazione Junggye, uscita 2', 'Junggye Station, exit 2'),
    sub: K('역세권', 'Area stazione', 'Station area'),
    lat: 37.645617, lng: 127.064939, m: 750,
    raw: 63345, idx: 97.0,
  },
  {
    ars: '11348', kind: 'resid',
    label: K('중계1동주민센터', 'Centro civico Junggye 1', 'Junggye 1-dong community centre'),
    sub: K('주거지', 'Area residenziale', 'Residential area'),
    lat: 37.651725, lng: 127.076938, m: 1698,
    raw: 116255, idx: 99.2,
  },
  {
    ars: '11395', kind: 'resid',
    label: K('중계주공2단지', 'Junggye Jugong 2', 'Junggye Jugong estate 2'),
    sub: K('주거지', 'Area residenziale', 'Residential area'),
...
export const CONTROL = { idx: 91.1, n: 536, label: K('노원구 평균', 'Media di Nowon', 'Nowon average') }
...
export const STOP_META = {
  ...
  src: K('서울 열린데이터광장 OA-12913 · 노원구 536개 정류장',
    ...
    'Open Data Seoul OA-12913 · 536 stops across Nowon'),
}
